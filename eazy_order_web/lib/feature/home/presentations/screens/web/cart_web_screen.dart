...
class CartWebScreen extends ConsumerStatefulWidget {
  const CartWebScreen({super.key, required this.businessId});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 12,),
              _orderPreference(state.businessModel?.orderPreference ?? [], state.selectedOrderPreference),
              SizedBox(height: 12,),
              _paymentOption(state.businessModel?.paymentOptions ?? [], state.selectedPaymentOption),
              SizedBox(height: 12,),
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return RadioListTile(
                onChanged: (val) => controller.onOrderPreferenceSelection(item),
                value: item,
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    if (item == 'Dine In' && selectedItem == 'Dine In') ... [
                      SizedBox(height: 12,),
                      Text(
                        'Please enter dine in table number',
                        style: GoogleFonts.nunito(
                            fontSize: 9,
                            fontWeight: FontWeight.w500,
                            color: AppColors.black
                      ...
                      CommonTextField(
                        onChanged: (val) => controller.onTableNumberChanged(val),
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return RadioListTile(
                onChanged: (val) {
                  ref.read(productListingControllerProvider.notifier).onPaymentOptionSelection(item);
                },
                value: item,
                groupValue: selectedItem,
                contentPadding: EdgeInsets.zero,
