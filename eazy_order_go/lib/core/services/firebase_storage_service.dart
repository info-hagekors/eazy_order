...
class FirebaseStorageService {
  ...
  Future<List<File>> pickMultipleImagesFromGallery() async {
    ...
    final List<File> images = selectedImages.map((e) => File(e.path)).toList();
    return images;
  }

  // Upload image and return download URL
  Future<String?> uploadBusinessImage(File imageFile, String mobile) async {
    try {
  ...
  Future<List<String>> uploadMultipleProductImages(List<File> imageFiles, String businessId,) async {
